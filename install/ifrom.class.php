<?php
	...
	class Ifrom {	
		...
		function getAgreement(){
			...
			$fc.='<div class="center red-font">许可协议</div>';
		...
		function getDbFrom($info, $inputs, $error="tip-msg"){
			...
			$fc.='<input type="radio" name="DRIVER" checked value="mysqli" />&nbsp;mysqli&nbsp;&nbsp;&nbsp;&nbsp;';
			$fc.='<input type="radio" name="DRIVER" value="pdo" />&nbsp;pdo&nbsp;&nbsp;&nbsp;&nbsp;';
		...
		function getAdminFrom($info, $inputs, $error="tip-msg"){
			...
			$fc.='<input type="text" class="text-box" name="ADMIN_USER">';
			$fc.='</li>';
			
			$fc.='<li class="dark-row liimg">';
			$fc.='<span class="col_width">管理员密码</span>';
			$fc.='<input type="password" class="text-box" name="ADMIN_PWD">';
			$fc.='</li>';
			$fc.='<li class="light-row liimg">';
			$fc.='<span class="col_width">重复密码</span>';
			$fc.='<input type="password" class="text-box" name="ADMIN_REPWD"">';	
			$fc.='</li>';
			$fc.='<li class="dark-row liimg">';
			$fc.='<span class="col_width">管理员邮箱</span>';
			$fc.='<input type="text" class="text-box" name="ADMIN_MAIL">';	
			$fc.='</li>';
