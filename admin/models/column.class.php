	...
	class Column extends Cat {
		...
		function parsetree() {	
			...
			foreach($option as $value) {
				...
				$title = str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|',count(explode('-',$value['abspath']))-2).$input. '|--<a href="'.B_APP.'/article/index/pid/'.$value["id"].'">'.$value['title'].'</a><span style="font-size:9px">&nbsp;&nbsp;对应ID：'.$value['id'].'</span>';
