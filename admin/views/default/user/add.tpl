...
<div id="main">
	<div class="head-dark-box">
		<div class="tit">y用户管理>用户管理>添加用户</div>
	</div>
			...
			<ul class="viewmess">
				...
				<li class="light-row"> <span class="col_width">设置权限</span><span style="height:30px;">
					<label for="systemadmin>">
						<input id="systemadmin" type="checkbox" name="systemadmin" value="1">系统管理权限
					</label>
					<label for="useradmin">
						<input id="useradmin" type="checkbox" name="useradmin" value="1">用户管理权限
				...
				<li class="light-row"> <span class="col_width" style="height:60px;">内容权限</span> <span style="height:30px;"><{ section name=a loop=$column}>
					<label for="<{$column[a].id}>">
						<input id="<{$column[a].id}>" type="checkbox" name="<{$column[a].id}>" value="1">
